...
export default function Login() {
    ...
    if (registerPage) {
        return (
            ...
            <div
                className={cn(
                    'relative flex h-screen items-center justify-center bg-[url("/Stockpic.png")] bg-cover bg-center bg-no-repeat',
                ...
                <div className="z-10 w-full max-w-sm">
                    <Card>
                        ...
                        <CardFooter className="flex justify-end gap-2">
                            {/* Register Button */}
                            <Button type="button" onClick={() => auth.register(name, email, password)} disabled={auth.loading}>
        ...
        <div className={cn("grid h-screen place-items-center", spaceGrotesk.variable)} style={{ fontFamily: 'var(--font-space-grotesk)' }}>
            ...
            <div className="w-full max-w-sm">
                <Card>
                    ...
                    <CardFooter className="flex justify-end gap-2">
                        {/* Login Button */}
                        <Button type="button" onClick={() => auth.login(email, password)} disabled={auth.loading}>
                            {auth.loading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                            Login
                        </Button>
                        {/* Register Button */}
